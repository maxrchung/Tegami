...
void main() {
	...
	float amp1 = 100;
	Wave violin_p1_s1 = Wave(amp1, wavelength1, part1Velocity, Time("00:39:625").ms, Time("00:52:093").ms);
	...
	float amp2 = 100;
	Wave violin_p2_s1 = Wave(amp2, wavelength2, part2Velocity, Time("01:17:028").ms, Time("01:41:963").ms);
	wave2.push_back(violin_p2_s1);

	part2Velocity = 100;
	wavelength2 = 200;
	amp2 = 100;
	Wave violin_p2_s2 = Wave(amp2, wavelength2, part2Velocity, Time("01:41:963").ms, Time("02:16:248").ms);
	...
	float amp3 = 100;
	Wave violin_p3_s1 = Wave(amp3, wavelength3, part3Velocity, Time("02:19:365").ms, Time("02:44:300").ms);
	...
	wavelength4 = 2;
	amp4 = 3;
	Wave violin_p4_s1 = Wave(amp4, wavelength4, part4Velocity, Time("03:09:235").ms, Time("03:43:521").ms); //3:09:235
	wave4.push_back(violin_p4_s1);

	part4Velocity = 4;
	wavelength4 = 5;
	amp4 = 6;
 	Wave violin_p4_s2 = Wave(amp4, wavelength4, part4Velocity, Time("03:43:521").ms, Time("03:46:648").ms); //3:43:521
	wave4.push_back(violin_p4_s2);

	part4Velocity = 7;
	wavelength4 = 8;
	amp4 = 9;
	Wave violin_p4_s3 = Wave(amp4, wavelength4, part4Velocity, Time("03:46:648").ms, Time("03:55 : 989").ms); //3:46:648
